...
class AuthController extends Notifier<AuthState> {
  ...
  Future<void> logout() async {
    try {
      ...
      // Local sign-out must complete even when the remote session-revocation
      // request or device storage cleanup fails. Otherwise Flutter reports an
      // uncaught async exception while the router is changing to login.
    } finally {
      state = const AuthState.unauthenticated();
    }
  }
